...
## This function creates a special "matrix", which is really a list containing a function 
## to 1) set the value of the matrix, 2) get the value of the matrix, 
## 3) set the value of the inverse of the matrix, and 4) get the value of the inverse of the matrix. 
